 ...
 * Generated at: 2021-07-03 06:05:05 UTC
...
public final class cart_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.semi4.vo.Cart");
    ...
    _jspx_imports_classes.add("com.semi4.dao.CartDao");
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
   ...
   Admin loginedAdmin = (Admin) session.getAttribute("LOGINED_ADMIN");
	...
	if (loginedUser == null) {
      ...
      out.write(" 님의 장바구니입니다.</span>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\t<div class=\"docs-section col-sm-12\">\r\n");
      out.write("\t\t\t\t\t<p class=\"text-danger\"><strong>※ JHTA Games의 정상가 기준은 소비자 금액으로 적용 되었습니다.</strong></p>\r\n");
      out.write("\t\t\t\t\t<p class=\"text-danger\"><strong>※ 장바구니는 최소 1개의 상품을 선택 후 주문을 하시길 바랍니다.</strong></p>\r\n");
      out.write("\t\t\t\t\t<p class=\"text-danger\"><strong>※ 상품할인 이벤트 시 상품을 구매할 때 가격을 유의하시길 바랍니다. (모든 상품을 이벤트를 하지 않기 때문에 일부상품은 제외될수 있습니다.)</strong></p>\r\n");
      ...
      out.write("\r\n");
      out.write("\t<form id=\"cart-form\" class=\"form-inline\" action=\"deleteselectedcart.jsp\" method=\"get\">\r\n");
      out.write("\t<div class=\"col-sm-12\">\r\n");
      out.write("\t\t<table class=\"table\">\r\n");
      out.write("\t\t\t<thead>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th><input type=\"checkbox\" id=\"ck-all\" onchange=\"changeAllAndNone()\"/></th>\r\n");
      out.write("\t\t\t\t\t<th>이미지</th>\r\n");
      out.write("\t\t\t\t\t<th>상품명</th>\r\n");
      out.write("\t\t\t\t\t<th>수량</th>\r\n");
      out.write("\t\t\t\t\t<th>가격</th>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"8\" class=\"text-center\">장바구니에 담긴 상품이 없습니다</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t");
      ...
      out.print(cart.getNo() );
      out.write("\" onchange=\"updateTotalPrice()\"></td>\r\n");
      out.write("\t\t\t\t\t<td><img src=\"../resources/images/gameImages/");
      out.print(cart.getGame().getImageFileName() );
      out.write("\" width=\"220px;\" height=\"100px;\"></td>\r\n");
      out.write("\t\t\t\t\t<td><a href=\"gamedetail.jsp?gameno=");
      out.print(cart.getGame().getNo() );
      out.write('"');
      out.write('>');
      out.print(cart.getGame().getTitle() );
      out.write("</a></td>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      ...
      out.print(1 ==cart.getAmount()?"selected":"" );
      out.write(" >1</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"2\" ");
      out.print(2 ==cart.getAmount()?"selected":"" );
      out.write(" >2</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"3\" ");
      out.print(3 ==cart.getAmount()?"selected":"" );
      out.write(" >3</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"4\" ");
      out.print(4 ==cart.getAmount()?"selected":"" );
      out.write(" >4</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"5\" ");
      out.print(5 ==cart.getAmount()?"selected":"" );
      out.write(" >5</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"6\" ");
      out.print(6 ==cart.getAmount()?"selected":"" );
      out.write(" >6</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"7\" ");
      out.print(7 ==cart.getAmount()?"selected":"" );
      out.write(" >7</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"8\" ");
      out.print(8 ==cart.getAmount()?"selected":"" );
      out.write(" >8</option>\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"9\" ");
      out.print(9 ==cart.getAmount()?"selected":"" );
      out.write(" >9</option>\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td><del id=\"p-");
      out.print(cart.getNo() );
      out.write('"');
      out.write('>');
      out.print(NumberUtils.numberWithComma(cart.getGame().getPrice()) );
      out.write(" 원</del></td>\r\n");
      out.write("\t\t\t\t\t<td><span id=\"dp-");
      out.print(cart.getNo() );
      out.write('"');
      out.write('>');
      out.print(NumberUtils.numberWithComma(cart.getGame().getDiscountPrice()) );
      out.write("</span> 원</td>\r\n");
      out.write("\t\t\t\t\t<td><strong id=\"sp-");
      out.print(cart.getNo() );
      out.write('"');
      out.write('>');
      out.print(NumberUtils.numberWithComma(cart.getGame().getDiscountPrice() * cart.getAmount()) );
      out.write("</strong> 원</td>\r\n");
      out.write("\t\t\t\t\t<td><a href=\"\" class=\"btn btn-info btn-xs\" onclick=\"updateAmount(");
      out.print(cart.getNo() );
      out.write(", event)\">변경</a></td>\r\n");
      out.write("\t\t\t\t\t<td><a href=\"deletecart.jsp?cartno=");
      out.print(cart.getNo() );
      ...
      out.write("\t\t\t\t\t\t<a href=\"deleteallcart.jsp\" class=\"btn btn-default\">전체 삭제</a>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"btn btn-default\" onclick=\"delSelectedItem(event)\">선택 삭제</button>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"7\">합계:</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"2\"><strong id=\"total-price-box\"></strong>원</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</tbody>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t<!-- text-right 오른쪽 정렬 -->\r\n");
      out.write("\t\t<div class=\"col-sm-12 text-right\">\t\r\n");
      out.write("\t\t\t<a href=\"gamemenu.jsp\" class=\"btn btn-danger btn-lg\">홈으로</a>\r\n");
      out.write("\t\t\t<a href=\"#\" onclick=\"selectOrder(event)\" class=\"btn btn-primary btn-lg\">주문하기</a>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\t\r\n");
      out.write("\tfunction selectOrder(event) {\r\n");
      out.write("\t\tevent.preventDefault();\r\n");
      out.write("\t\t// checkbox 접근 후 체크된 개수 파악하기\r\n");
      out.write("\t\tvar checkedSize = document.querySelectorAll(\"input[name='cartno']:checked\").length;\r\n");
      out.write("\t\tif (checkedSize == 0) {\r\n");
      out.write("\t\t\talert(\"선택된 상품이 없습니다.\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// getElementById(\"cart-form\")을 호출해서 .setAttribute(action을 orderform.jsp)로 바꾸기\r\n");
      out.write("\t\tdocument.getElementById(\"cart-form\").setAttribute(\"action\", \"orderform.jsp\")\r\n");
      out.write("\t\t// 수정한 cart-form을 보내기\r\n");
      out.write("\t\tdocument.getElementById(\"cart-form\").submit();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction changeAllAndNone() {\r\n");
      out.write("\t\t// 전체 체크박스의 현재 체크여부 조회하기\r\n");
      out.write("\t\tvar checkedStatus = document.querySelector(\"#ck-all\").checked;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// name이 \"ck-gameno\"인 모든 엘리먼트를 호출하기\r\n");
      out.write("\t\tvar checkBoxes = document.querySelectorAll(\"input[name='cartno']\");\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfor (var i=0; i<checkBoxes.length; i++) {\r\n");
      out.write("\t\t\tvar checkBox = checkBoxes[i];\r\n");
      out.write("\t\t\tcheckBox.checked = checkedStatus;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tupdateTotalPrice();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction updateAmount(cartNo, e) {\r\n");
      out.write("\t\te.preventDefault();\r\n");
      out.write("\t\tvar amount = document.getElementById(\"amount-\" + cartNo).value;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t// 주소창에 주소를 바꾼다 : location.href\r\n");
      out.write("\t\tlocation.href=\"changeamountcart.jsp?cartno=\" + cartNo + \"&amount=\" + amount;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction delSelectedItem(e) {\r\n");
      out.write("\t\tevent.preventDefault();\r\n");
      out.write("\t\tvar checkedBox= document.querySelectorAll(\"input[name='cartno']:checked\");\r\n");
      out.write("\t\tif (checkedBox.length == 0) {\r\n");
      out.write("\t\t\talert(\"선택된 상품이 없습니다.\");\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tdocument.getElementById(\"cart-form\").submit();\r\n");
      ...
      out.write("\t\tvar totalBox = document.getElementById(\"total-price-box\")\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar checkedCheckBoxes = document.querySelectorAll(\"input[name='cartno']:checked\");\r\n");
      out.write("\t\tif (checkedCheckBoxes.length == 0) {\r\n");
      out.write("\t\t\ttotalBox.textContent = 0;\r\n");
      out.write("\t\t\treturn;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tvar totalPrice = 0\r\n");
      out.write("\t\tfor (var i=0; i<checkedCheckBoxes.length; i++) {\r\n");
      out.write("\t\t\tvar checkbox = checkedCheckBoxes[i];\r\n");
      out.write("\t\t\tvar cartno = checkbox.value;\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tvar str = document.getElementById(\"sp-\"+cartno).textContent;\r\n");
      out.write("\t\t\tstr = str.replace(/,/g, \"\");\r\n");
      out.write("\t\t\tvar sumPrice = parseInt(str);\r\n");
      out.write("\t\t\ttotalPrice += sumPrice;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tvar currency = new Number(totalPrice);\r\n");
      out.write("\t\ttotalBox.textContent = currency.toLocaleString();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("</script>\r\n");
