...
%>
			...
			<div class="row">
				<div class="col-sm-offset-1 col-sm-10">
					<form class="well" method="post" id="register-form" enctype="multipart/form-data" action="adminGameRegister.jsp"
...
%>
						...
						<div class="form-group">
							...
							%>
								<option value="<%=publisher.getNo() %>"><%=publisher.getName() %></option>
							<%
								}
							%>
						...
						<div class="form-group">
							<label>게임 소개</label>
							<textarea class="form-control" style="width: 100%; min-height:300px; resize: none; border: 1;" name="intro" id="game-intro"></textarea>
						</div>
						<div class="form-group">
							<label>시스템 요구 사항</label>
							<textarea class="form-control" style="width: 100%; min-height:300px; resize: none; border: 1;" name="requirement" id="game-requirement"></textarea>
						</div>
