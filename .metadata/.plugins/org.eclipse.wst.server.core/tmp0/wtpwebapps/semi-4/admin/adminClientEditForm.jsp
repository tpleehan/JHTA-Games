...
%>
			<h3 class="text-center" style="font-weight: bold;">관리자 개인정보 수정하기</h3><br><br>
		</div>
		<div class="row">
			<div class="col-sm-offset-1 col-sm-10">
				<form class="well" method="post" id="edit-form" action="adminClientEdit.jsp">
						<div class="form-group">
							<label>관리자 아이디</label>
							<input type="text" class="form-control" name="id" value="<%=getAdmin.getId() %>" readOnly/>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>관리자 이름</label>
							<input type="text" class="form-control" name="name" id="admin-name" value="<%=getAdmin.getName() %>"/>
						</div>
						<div class="form-group">
							<label>관리자 등급</label>
							<input type="text" class="form-control" name="grade" value="<%=getAdmin.getGrade() %>" readOnly/>
						</div>
...
%>
	<div class="row">
		<div class="col-sm-12">
			<h3 class="text-center">관리자 수정하기</h3><br><br>
		</div>
		<div class="row">
			<div class="col-sm-offset-1 col-sm-10">
				<form class="well" method="post" id="edit-form2" action="adminClientEditForm2.jsp">
					<div class="form-group">
						<label>관리자 선택</label>
	...
	%>
							...
							아이디:<%=foundAdmin.getId() %>, 이름:<%=foundAdmin.getName() %>, 등급: <%=foundAdmin.getGrade() %></option>
	<%
		}
	%>
								</select>
							...
							<div class="text-right">
								<button type="submit" class="btn btn-primary" id="edit-button">관리자 수정</button>
							</div>
						</form>
			</div>
		</div>
