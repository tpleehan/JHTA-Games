			...
			<div class="row">
				<div class="col-sm-12">
					<h3 class="text-center" style="font-weight: bold;">QNA 게시판 관리</h3><br><br>
						...
						<a href="adminQnaNoAnswer.jsp"><button class="btn btn-primary">답변대기 게시글 보기</button></a>
						<a href="adminQnaAnswerCompleted.jsp"><button class="btn btn-default">답변완료 게시글 보기</button></a>
						<hr/>
					...
					<div>
						...
						%>
								<tr>
									<td><%=qna.getNo() %></td>
									<td><a href="adminQnadetail.jsp?qnaNo=<%=qna.getNo() %>&where=ready"><%=qna.getTitle() %></a></td>
