...
%>
	...
	%>
							...
							<option value="<%=foundAdmin.getId() %>" <%=foundAdmin.getId().equals(getAdmin.getId()) ? "hidden" : "" %>>
	...
	%>
							...
							<div class="text-right">
								<button onclick="deleteAdminClient()" class="btn btn-danger" id="edit-button">관리자 삭제</button>
							</div>
						</form>
			</div>
		</div>
