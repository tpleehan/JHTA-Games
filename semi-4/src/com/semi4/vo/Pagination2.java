...
public class Pagination2 {
	...
	private int listPerPage;        // 한 페이지당 표시할 데이터, 기본값 9
	...
	/**
	 * Pagination객체를 생성한다.
	 * @param pageNo 요청한 페이지 번호, 기본값 9로 설정
	 * @param totalCnt 전체 데이터 개수, 기본값 5로 설정
	 */
	public Pagination2(int pageNo, int totalCnt) {
		this.listPerPage = 9;
		this.pagesPerPage = 5;
		this.pageNo = pageNo;
	 ...
	 */
	public Pagination2(int pageNo, int totalCnt, int listPerPage) {
	 ...
	 */
	public Pagination2(int pageNo, int totalCnt, int listPerPage, int pagesPerPage) {
		this.listPerPage = listPerPage;
