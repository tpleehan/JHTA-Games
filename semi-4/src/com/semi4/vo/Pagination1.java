...
public class Pagination1 {
	 ...
	 */
	public Pagination1(int pageNo, int totalRows) {
		this.rowsPerPage = 5;
		this.pagesPerPage = 5;
		this.pageNo = pageNo;
	 ...
	 */
	public Pagination1(int pageNo, int totalRows, int rowsPerPage) {
	 ...
	 */
	public Pagination1(int pageNo, int totalRows, int rowsPerPage, int pagesPerPage) {
		this.rowsPerPage = rowsPerPage;
