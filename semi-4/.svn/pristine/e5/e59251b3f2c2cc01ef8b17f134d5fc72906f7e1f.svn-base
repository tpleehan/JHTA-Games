				...
				<div class="col-sm-offset-1 col-sm-10">
					<form class="well" method="post" id="edit-form" action="adminClientEdit.jsp">
							<div class="form-group">
								<label>관리자 아이디</label>
								<input type="text" class="form-control" name="id" value="<%=foundAdmin.getId() %>" readOnly/>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label>관리자 이름</label>
								<input type="text" class="form-control" name="name" id="admin-name" value="<%=foundAdmin.getName() %>"/>
							</div>
							<div class="form-group">
