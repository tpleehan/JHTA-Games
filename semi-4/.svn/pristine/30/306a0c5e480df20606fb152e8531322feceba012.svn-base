			...
			<div class="col-sm-9" style="border-left: 2px solid grey; height:1000px;">
				...
				<div class="col-sm-12">
					<h3 class="text-center" style="font-weight: bold;">월간 수익 조회</h3><br><br>
						...
						<a href="adminProfitByDay.jsp"><button class="btn btn-default">일간 수익</button></a>
						<a href="adminProfitByMonth.jsp"><button class="btn btn-primary">월간 수익</button></a>
						<hr/>
						<div class="row">
							<div class="col-md-12">
									...
									<div class="text-center" style="font-weight: bold;">
										...
										<form method="post" action="adminProfitByMonth.jsp">
											<input class="text-center" type="month" name="profitmonth" id="profit-month" value="<%=profitMonth!= null ? profitMonth : ""%>">
