			...
			<div class="row">
				...
				<div class="col-sm-12">
					...
					%>
								...
								<tr>
									<td><%=notice.getNo() %></td>
									<td style="text-overflow: ellipsis; overflow: hidden; height: 3px; white-space: nowrap;"><a href="noticeDetail.jsp?no=<%=notice.getNo() %>&pageno=<%=pageNo %>"><%=notice.getTitle() %></a></td>
									<td><%=noticeAdmin.getName() %></td>
									<td><%=DateUtil.dateToString(notice.getCreateDate()) %></td>
	            	...
	            	<a href="noticeRegisterForm.jsp"><button class="btn btn-primary pull-right" type="button" style="margin-bottom: 30px;">글쓰기</button></a>
	            	<div class="row">
