				...
				<div class="col-sm-12" style="border-bottom: 1px solid grey;">
					...
					%>
								...
								<tr>
									...
									<th>
										<div class="form-group">
											<input class="form-control hidden" type="text" name="no" id="boardNo" value="<%=noticeBoard.getNo() %>">
											<%=noticeBoard.getNo() %>
										</div>
									</th>
								</tr>	
								<tr>
									...
									<th>
										<div class="form-group">
											<input class="form-control" type="text" name="title" id="title" style="border: 0px;"
									...
									<th>
										<div class="form-group">
											<textarea class="col-12" name="content" style="width: 100%; min-height:300px; 
											 resize: none; border: 0;" id="content"><%=noticeBoard.getContent() %></textarea>
										 </div>
									 </th>
								</tr>
								<tr>
									<th class="info">조회수</th>
									<th style="padding-bottom: 50px;"><%=noticeBoard.getCount() %></th>
								</tr>
						</table>
						<hr/>
						<div class="form-group hidden">
							...
							<div class="col-sm-12">
								<a href="adminNotice.jsp?pageno=<%=pageNo %>"><button class="btn btn-success pull-right" type="button" style="margin: 20px 10px;">목록으로</button></a>
								<button class="btn btn-primary pull-right" type="button" onclick="editNotice()" style="margin: 20px 10px;">수정</button>
								<button class="btn btn-danger pull-right" type="button" onclick="deleteNotice(<%=noticeBoard.getNo() %>)" style="margin: 20px 10px;">삭제</button>
							</div>
						</div>
					</form>
				</div>
