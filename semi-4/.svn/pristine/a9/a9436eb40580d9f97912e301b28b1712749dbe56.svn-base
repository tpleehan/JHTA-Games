			...
			<div class="col-sm-9" style="border-left: 2px solid grey; height:565px;">
				<div class="row">
					<div class="col-sm-12">
						...
						<p class="text-center"><strong style="color: blue;"><%=loginedAdmin.getId() %>(<%=loginedAdmin.getName() %>)</strong> 님은 <strong style="color: red;"><%=loginedAdmin.getGrade() %></strong>등급 관리자입니다.</p><br>
