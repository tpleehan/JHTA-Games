			...
			<div class="row">
				<div class="col-sm-offset-1 col-sm-10">
					<form class="well" method="post" id="edit-form" action="adminDeleteGame.jsp">
						...
						<div class="form-group">
							<label>게임 제목</label>
							<input type="text" class="form-control" name="title" id="game-title" value="<%=game.getTitle() %>" readOnly/>
						</div>
						<div class="form-group">
							<label>가격</label>
							<input type="text" class="form-control" name="price" id="game-price" value="<%=game.getPrice() %>" readOnly/>
						</div>
						<div class="form-group">
							<label>할인가격</label>
							<input type="text" class="form-control" name="discountPrice" id="game-discountPrice" value="<%=game.getDiscountPrice() %>" readOnly/>
						</div>
						<div class="form-group">
							<label>출시일</label>
							<input type="date" class="form-control" name="createDate" id="game-createDate" value="<%=date %>" readOnly/>
						</div>
						<div class="form-group">
							<label>장르</label>
<%
...
%>
						...
						<div class="form-group">
							...
							%>
							<input type="text" class="form-control" name="publisher" value="<%=publisher.getName() %>" readOnly/>
						</div>
						<div class="form-group">
							<label>썸네일 이미지</label>
					...
					%>
						...
						<div class="form-group">
							<label>게임 소개</label>
							<textarea class="form-control" rows="8" name="intro" id="game-intro" readOnly><%=game.getIntro() %></textarea>
						</div>
						<div class="form-group">
							<label>시스템 요구 사항</label>
							<textarea class="form-control" rows="8" name="requirement" id="game-requirement" readOnly><%=game.getRequire() %></textarea>
						</div>
						<div class="form-group">
