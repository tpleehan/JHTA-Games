...
<div class="container">
    ...
    <div class="col-sm-9" style="border-left: 2px solid grey; height:1000px;">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="text-center" style="font-weight: bold;">월간 수익 조회</h3><br><br>
                <a href="adminProfits.jsp">
                    <button class="btn btn-default">총 수익</button>
                </a>
                <a href="adminProfitByDay.jsp">
                    <button class="btn btn-default">일간 수익</button>
                </a>
                <a href="adminProfitByMonth.jsp">
                    <button class="btn btn-primary">월간 수익</button>
                </a>
                <hr/>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <%
                            String profitMonth = request.getParameter("profitmonth");
                            if (profitMonth == null) {
                                Date today = new Date();
                                profitMonth = DateUtil.dateToMonth(today);
                            }

                            Map<String, String> opt = new HashMap<>();
                            opt.put("opt", "month");
                            opt.put("keyword", profitMonth);
                        %>

                        <div class="table-responsive">
                            <div class="text-center" style="font-weight: bold;">
                                <h4><strong>날짜 선택</strong></h4>
                                <form method="post" action="adminProfitByMonth.jsp">
                                    <input class="text-center" type="month" name="profitmonth" id="profit-month"
                                           value="<%=profitMonth!= null ? profitMonth : ""%>">
                            ...
                            <table class="table table-dark table-hover" style="border:2px solid black; width:100%;">
                                ...
                                %>
                                <tr>
                                    <td><%=result.getPublisherName() %>
                                    </td>
                                    <td><%=result.getAction() %>
                                    </td>
                                    <td><%=result.getAdventure() %>
                                    </td>
                                    <td><%=result.getSports() %>
                                    </td>
                                    <td><%=result.getRpg() %>
                                    ...
                                    <td class="info" style="font-weight: bold;"><%=result.getTotal() %>
                                    </td>
                                </tr>
                                <%
                                    }
                                ...
                                <tr class="info" style="font-weight: bold;">
                                    ...
                                    %>
                                    <td><%=resultTotal.getAction() %>
                                    </td>
                                    <td><%=resultTotal.getAdventure() %>
                                    </td>
                                    <td><%=resultTotal.getSports() %>
                                    </td>
                                    <td><%=resultTotal.getRpg() %>
                                    </td>
                                    <td><%=resultTotal.getFps() %>
                                    </td>
                                    <td><%=resultTotal.getPuzzle() %>
                                    </td>
                                    <td><%=resultTotal.getSim() %>
                                    </td>
                                    <td><%=resultTotal.getStr() %>
                                    </td>
                                    <td><%=resultTotal.getEtc() %>
                                    </td>
                                    <td><%=resultTotal.getTotal() %>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
