...
<div class="container">
    ...
    <div class="col-sm-9" style="border-left: 2px solid grey; height:1000px;">
        <div class="row">
            <div class="col-sm-12">
                <h3 class="text-center" style="font-weight: bold;">수익 조회</h3><br><br>
                <a href="adminProfits.jsp">
                    <button class="btn btn-primary">총 수익</button>
                </a>
                            ...
                            <table class="table table-dark table-hover" style="border:2px solid black; width:100%;">
                                ...
                                <tr class="info" style="font-weight: bold;">
                                    ...
                                    <%
                                        ...
                                        int allSales = 0;
                                        for (Genre genre : allGenres) {
                                            int totalSales = profitDao.getTotalProfitByGenre(genre.getNo());
                                    %>
                                    <td><%=totalSales %>
                                    </td>
                                    <%
