        ...
        <div class="row">
            <div class="col-sm-offset-1 col-sm-10">
                <form class="well" method="post" id="register-form" action="noticeRegister.jsp"
                    ...
                    <div class="form-group">
                        <label>작성자</label>
                        <input type="text" class="form-control hidden" name="admin" id="notice-admin"
                               value="<%=loginedAdmin.getId() %>"/>
                        <input type="text" class="form-control" name="writer" id="notice-writer"
                               value="<%=loginedAdmin.getName() %>" readonly/>
                    </div>
                    <div class="form-group">
                        <label>본문</label>
                        <textarea class="form-control" style="width: 100%; min-height:300px; resize: none; border: 1;"
                                  name="content" id="notice-content"></textarea>
                    </div>
