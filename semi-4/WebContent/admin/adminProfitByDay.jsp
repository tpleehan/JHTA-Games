        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <a href="adminProfitByDay.jsp">
                    <button class="btn btn-primary">일간 수익</button>
                </a>
                <a href="adminProfitByMonth.jsp">
                    <button class="btn btn-default">월간 수익</button>
                </a>
                <hr/>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="table-responsive">
                            <div class="text-center" style="font-weight: bold;">
                                ...
                                <form method="post" action="adminProfitByDay.jsp">
                                    <input class="text-center" type="date" name="profitday" id="profit-day"
                                           value="<%=profitday!= null ? profitday : ""%>">
