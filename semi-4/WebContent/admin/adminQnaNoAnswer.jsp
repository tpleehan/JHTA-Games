        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <a href="adminQnaNoAnswer.jsp">
                    <button class="btn btn-primary">답변대기 게시글 보기</button>
                </a>
                <a href="adminQnaAnswerCompleted.jsp">
                    <button class="btn btn-default">답변완료 게시글 보기</button>
                </a>
                <hr/>
                ...
                <div>
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><a href="adminQnadetail.jsp?qnaNo=<%=qna.getNo() %>&where=ready"><%=qna.getTitle() %>
                            </a></td>
                            <td><%=writer.getName() %>
                            </td>
