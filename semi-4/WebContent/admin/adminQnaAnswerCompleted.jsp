    ...
    <div class="col-sm-9" style="border-left: 2px solid grey;">
        <div class="row">
            <div class="col-sm-12">
                ...
                <a href="adminQna.jsp">
                    <button class="btn btn-default">전체 게시글 보기</button>
                </a>
                <a href="adminQnaNoAnswer.jsp">
                    <button class="btn btn-default">답변대기 게시글 보기</button>
                </a>
                <a href="adminQnaAnswerCompleted.jsp">
                    <button class="btn btn-primary">답변완료 게시글 보기</button>
                </a>
                <hr/>
                ...
                <div>
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="adminQnadetail.jsp?qnaNo=<%=qna.getNo() %>&where=completed"><%=qna.getTitle() %>
                                </a></td>
                            <td><%=writer.getName() %>
                            </td>
                            <td><%=DateUtil.dateToString(qna.getCreateDate()) %>
                            </td>
                            <td><%=qna.getCount() %>
                            </td>
