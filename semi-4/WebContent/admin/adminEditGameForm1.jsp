                        ...
                        <form class="well" method="post" id="edit-form" action="">
                            <div class="form-group">
                                ...
                                <select class="form-control inputbox" name="gameno" id="game-no">
                                    ...
                                    <option value="<%=game.getNo() %>"><%=game.getTitle() %>
                                    </option>
                                    <%
                                        }
                                    %>
                            ...
                            <div class="text-right">
                                <button onclick="editGame(event)" class="btn btn-primary" id="edit-button">게임 수정
                                </button>
                                <button onclick="deleteGame(event)" class="btn btn-danger" id="del-button">게임 삭제
                                </button>
                            </div>
                        </form>
                    </div>
