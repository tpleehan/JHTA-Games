...
<%@page import="com.sun.xml.internal.*"%>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="alert alert-danger">
					<strong>회원가입 실패</strong> 동일한 아이디가 존재합니다.
				</div>
			</div>
		</div>
	<%		
	...
	<div class="docs-section">
		<div class="row col-sm-12">
			...
			<div class="well">
				...
				<div class="checkbox">
					<label class="control-label"><input type="checkbox" id="collectionChecked1">개인정보 수집 및 이용에 동의합니다.</label>
				</div>
				<p class="text-danger" ><strong>※ 중앙HTA 게임즈 서비스 제공을 위해서 필요한 최소한의 개인정보이므로 동의를 해 주셔야 서비스를 이용하실 수 있습니다.</strong></p>
			</div>
		</div>
	</div>
	
	<!-- 이용약관에 수집에 관련된 테이블이다. rows="10"을 하여 화면에 나타나는 줄 수는 10줄이다. readonly를 이용해 테이블안에 있는 글자를 수정하지 못하도록 설정 되어 있다.   -->
	<div class="docs-section">
		<div class="row col-sm-12">
			<div class="page-header">
				<h4>이용약관(필수)</h4>
			...
			<div class="well">
				<textarea id="agreement" class="form-control" rows="10" readonly="readonly">
제1조(목적)
이 약관은 주식회사 중앙HTA(이하 "회사"라고 합니다)가 “중앙HTA 게임즈” 인터넷 사이트(http://www.directg.net, 이하 "중앙HTA 게임즈” 라고 합니다)를 통하여 제공하는 인터넷 관련 서비스 및 기타 정보서비스(이하 "서비스"라고 합니다)와 관련하여 회사와 회원간의 권리와 의무, 책임사항 및 회원의 서비스이용절차에 관한 사항을 규정함을 목적으로 합니다.

* 「스마트폰 등 이동통신기기 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의)
①"중앙HTA 게임즈" 란 회사가 재화 또는 용역(이하 "재화 등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버 몰을 운영하는 사업자의 의미로도 사용합니다.
...
① "회사"는 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 이메일, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자 등을 이용자가 쉽게 알 수 있도록 중앙HTA 게임즈의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
④ "회사"가 약관을 개정할 경우에는 적용일자 및 개정사유를 명시하여 현행약관과 함께 중앙HTA 게임즈의 초기화면에 그 적용일자 7일 이전부터 적용일자 전일까지 공지합니다. 
다만, 이용자에게 불리하게 약관내용을 변경하는 경우에는 최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이 경우 "회사"는 개정 전 내용과 개정 후 내용을 명확하게 비교하여 이용자가 알기 쉽도록 표시합니다.

⑤ "회사"가 약관을 개정할 경우에는 그 개정약관은 그 적용일자 이후에 체결되는 계약에만 적용되고 그 이전에 이미 체결된 계약에 대해서는 개정전의 약관조항이 그대로 적용됩니다. 다만 이미 계약을 체결한 이용자가 개정약관 조항의 적용을 받기를 원하는 뜻을 제3항에 의한 개정약관의 공지 기간 내에 “중앙HTA 게임즈"에 송신하여 "중앙HTA 게임즈"의 동의를 받은 경우에는 개정약관 조항이 적용됩니다.
...
2. "중앙HTA 게임즈"를 이용하여 구입한 재화 등의 대금, 기타 "중앙HTA 게임즈"이용에 관련하여 회원이 부담하는 채무를 기일에 지급하지 않는 경우
3. 다른 사람의 "중앙HTA 게임즈" 이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우
4. "중앙HTA 게임즈"를 이용하여 법령 또는 이 약관이 금지하거나 공서양속에 반하는 행위를 하는 경우
...
② "회사"는 불특정다수 회원에 대한 통지의 경우 1주일이상 "중앙HTA 게임즈" 게시판에 게시함으로써 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 개별통지를 합니다.

제9조(구매신청)
"중앙HTA 게임즈" 이용자는 "중앙HTA 게임즈"상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, "회사"는 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.  단, 회원인 경우 제2호 내지 제4호의 적용을 제외할 수 있습니다.
1. 재화등의 검색 및 선택
2. 닉네임, 전자우편주소 입력
3. 약관내용, 청약 철회권이 제한되는 서비스의 비용부담과 관련한 내용에 대한 확인
4. 이 약관에 동의하고 위 3.호의 사항을 확인하거나 거부하는 표시(예, 마우스 클릭)
5. 재화 등의 구매신청 및 이에 관한 확인 또는 "중앙HTA 게임즈"의 확인에 대한 동의
6. 결제방법의 선택
...
3. 기타 구매신청에 승낙하는 것이 "중앙HTA 게임즈" 기술상 현저히 지장이 있다고 판단하는 경우
...
2. 타인의 정보 도용
3. "중앙HTA 게임즈"에 게시된 정보의 변경
4. "중앙HTA 게임즈"가 정한 정보 이외의 정보(컴퓨터 프로그램 등) 등의 송신 또는 게시
5. "중앙HTA 게임즈" 기타 제3자의 저작권 등 지적재산권에 대한 침해
6. "중앙HTA 게임즈" 기타 제3자의 명예를 손상시키거나 업무를 방해하는 행위
7. 외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 중앙HTA 게임즈에 공개 또는 게시하는 행위
...
제24조(게시판의 이용)
가. 게시판 이용 원칙 
1) 회사는 중앙HTA 게임즈 내에서 회원들이 지식을 공유할 수 있는 게시판을 운영하거나, 일정한 자격을 가진 회원들이 이를 운영할 수 있도록 할 수 있습니다. 
2) 게시물로 인해 발생하는 저작권 침해를 비롯한 민,형사상의 모든 책임은 당해 게시물의 게시자에게 있으며, 회사는 이에 대해 책임지지 않습니다. 
나. 게시물의 저작권 
1) 중앙HTA 게임즈의 게시판에 회원이 등록한 게시물의 저작권은 제3자의 권리를 침해하지 않는 한, 등록한 회원에게 속합니다. 
...
나. 본 서비스를 위반하거나 서비스 이용 시 불편 사항이 발생한 경우 주식회사 중앙HTA의 "고객지원" 서비스 또는 support@h2interactive.co.kr을 이용하시거나 전화 (1544-2367) 또는 Fax (02-6929-3865)로 알려주시면 성심껏 처리해 드리겠습니다. 

다. 회사소개
1) 주식회사 중앙HTA
2) 소재지 : 서울특별시 종로구 봉익동 율곡로10길 105 디아망 빌딩 4층
3) 대표이사 : 이준스쨔응
4) 사업자 등록번호 : 010-1234-5678

본 약관은 2019년 12월 10일 부터 적용됩니다.	
				</textarea>
				<div class="checkbox">
					<label class="control-label"><input type="checkbox" id="collectionChecked2">이용약관에 동의합니다.</label>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="docs-section">
		<div class="row col-sm-12">
			...
			<form id="register-form" class="well" action="register.jsp" method="post">
				<div class="form-group" >
					<div class="form-inline form-group" style="padding-bottom:30px;">
						<label class="col-sm-2">아이디</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="userid" id="user-id" readonly="readonly" />
							<input type="button" value="중복확인" name="confirm_id" id="idcheck" onclick="checkId()" style="margin-left: 10px;"/>
					...
					<div class="form-inline form-group" style="padding-bottom:30px;">
						...
						<div class="col-sm-10">
							<select name="usertel1" id="user-tel1" class="form-control inputbox">
							...
							<input type="text" class="form-control" name="usertel2" id="user-tel2" style="width:150px;" />
							<span style="color:#999999">-</span>
							<input type="text" class="form-control" name="usertel3" id="user-tel3"  style="width:150px;" />
						</div>
					</div>
					...
					<div class="form-inline form-group" style="padding-bottom:30px;">
						...
						<div class="checkbox col-sm-10">
							<input type="text" class="form-control" id="user-email" name="useremail" />
							
							<span style="color:#999999">@</span>

							<input type="text" class="form-control" id="user-email2" name="useremail2"  style="width:150px;">

							<select id="user-email3" name="useremail3" class="form-control inputbox" onchange="changeEmail()">
					...
					<div class="form-inline form-group" style="padding-bottom:30px;">
						...
						<div class="checkbox col-sm-10">
							<input type="checkbox" class="control-label" id="emailChecked" />
								정보/이벤트 메일 수신에 동의합니다
							<p class="text-danger" ><strong>※ 주문 관련 정보, 주요 공지사항 및 이벤트 당첨 안내 등은 수신 동의 여부에 관계없이 자동 발송됩니다..</strong></p>
						</div>
					</div>
				</div>
				
				<div class="text-center" style="padding-top:20px;">
					<button onclick="checkFormfield(event)" type="button" class="btn btn-primary">회원가입</button>
					<a href="../home.jsp"><button type="button" class="btn btn-default">취소하기</button></a>
				</div>	
			</form>
		</div>
	</div>
...
<script type="text/javascript">
	function changeEmail() {
		var x = document.getElementById("user-email3").value;
		document.getElementById("user-email2").value = x;
	}
	
	function checkId() {
		window.open("idcheckpopup.jsp", "idcheck", "width=500,height=300,resizable=0");
		var idcheck = document.querySelector("#user-id").value;
	}
	
	function checkFormfield(event) {
		var isChecked1 = document.querySelector("#collectionChecked1").checked;
		var isChecked2 = document.querySelector("#collectionChecked2").checked;
		if (!isChecked1) {
			alert("개인정보 수집 및 이용(필수) 내역 확인 후 동의하시길 바랍니다.");
			event.preventDefault();
			return;
		}
		if (!isChecked2) {
			alert("이용약관(필수) 내역 확인 후 동의하시길 바랍니다.")
			event.preventDefault();
			return;
		}
		...
		var tel = document.querySelector("#user-tel2").value;
		if (tel == "") {
			alert("전화번호를 입력하세요.");
			return;
		}
